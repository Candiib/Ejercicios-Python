...
Realizar un programa que reciba por consola su nombre completo e imprima
en pantalla su nombre en los siguientes formatos:

  Todas las letras en minúsculas
  Todas las letras en mayúsculas
  Solo la primera letra del nombre en mayúscula

NOTA: Para realizar este ejercicio deberá usar los siguientes métodos de strings:
  lower
  upper
  capitalize'''
